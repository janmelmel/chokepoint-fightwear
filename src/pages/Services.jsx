    ...
    <div className="min-h-screen text-white" style={{ background: C.bg }}>
      ...
      <section className="relative overflow-hidden pt-20 pb-14 px-4">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.4 }}
            className="font-mono-ui text-[10px] uppercase tracking-[0.4em] mb-3" style={{ color: C.silver }}>
            Custom Fight Gear
          </motion.p>
      ...
      <section className="py-3 overflow-hidden" style={{ borderTop: `1px solid ${C.border}`, borderBottom: `1px solid ${C.border}`, background: C.surface }}>
        <div className="flex gap-10 items-center justify-center flex-wrap px-6">
          {['7–10 Business Day Turnaround', '20+ Years of Manufacturing', 'Full Sublimation Printing', 'No Hidden Fees', 'Custom for Teams & Academies'].map((item, i) => (
            <p key={i} className="font-mono-ui text-[10px] uppercase tracking-widest whitespace-nowrap flex items-center gap-2" style={{ color: '#444' }}>
      ...
      <section id="services" className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <p className="font-mono-ui text-[10px] uppercase tracking-[0.3em] mb-2" style={{ color: C.silver }}>What We Make</p>
                ...
                <button onClick={() => setActiveService(activeService === service.id ? null : service.id)}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                      <span className="font-mono-ui text-[9px] px-1.5 py-0.5"
                    ...
                    <p className="font-mono-ui text-[10px]" style={{ color: C.muted }}>{service.subtitle}</p>
                  </div>
                      ...
                      <div>
                        ...
                        <ul className="space-y-1.5">
                          {service.highlights.map((h, j) => (
                            <li key={j} className="flex items-center gap-2 font-mono-ui text-[10px] uppercase tracking-wide" style={{ color: C.text }}>
      ...
      <section className="py-16 px-4 relative overflow-hidden" style={{ borderTop: `1px solid ${C.border}`, background: C.surface }}>
        ...
        <div className="max-w-xl mx-auto text-center relative z-10">
          <p className="font-mono-ui text-[10px] uppercase tracking-[0.3em] mb-3" style={{ color: C.silver }}>Ready to Build?</p>
          ...
          <p className="font-mono-ui text-[10px] mt-6 uppercase tracking-widest" style={{ color: C.border }}>No Escape From Chokepoint.</p>
        </div>
      </section>
