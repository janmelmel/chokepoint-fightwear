          ...
          {cart.length > 0 && (
            <div className="space-y-2 pt-2">
              ...
              <button onClick={() => handleContact('Facebook')} disabled={!name || submitting}
                className="w-full py-3.5 font-mono-ui text-sm uppercase tracking-widest btn-glow-orange flex items-center justify-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed">
