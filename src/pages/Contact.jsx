        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <motion.a href="mailto:sales@chokepoint-fightwear.com" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
              ...
              <Mail className="w-5 h-5 text-[#4f8ef7] flex-shrink-0 mt-0.5" />
              <div>
                <p className="font-mono-ui text-[10px] text-[#555] uppercase tracking-widest mb-1">Email</p>
                <p className="font-mono-ui text-sm text-white group-hover:text-[#6ea8ff] transition-colors">sales@chokepoint-fightwear.com</p>
              </div>
            </motion.a>
            ...
            <motion.a href={FB_URL} target="_blank" rel="noreferrer" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}
              className="flex items-start gap-4 border border-[#1a1a1a] bg-[#111] p-5 hover:border-[#ff6b00]/40 transition-colors group">
              <MessageCircle className="w-5 h-5 text-[#4f8ef7] flex-shrink-0 mt-0.5" />
              <div>
                <p className="font-mono-ui text-[10px] text-[#555] uppercase tracking-widest mb-1">Facebook / Messenger</p>
                <p className="font-mono-ui text-sm text-white group-hover:text-[#6ea8ff] transition-colors">Chokepoint Fightwear</p>
            ...
            <motion.a href={IG_URL} target="_blank" rel="noreferrer" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
              className="flex items-start gap-4 border border-[#1a1a1a] bg-[#111] p-5 hover:border-[#ff6b00]/40 transition-colors group">
              <svg className="w-5 h-5 text-[#4f8ef7] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <p className="font-mono-ui text-sm text-white group-hover:text-[#6ea8ff] transition-colors">@chokepoint_fightwear</p>
              </div>
            </motion.a>
            ...
            <motion.a href={MAPS_URL} target="_blank" rel="noreferrer" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }}
              className="flex items-start gap-4 border border-[#1a1a1a] bg-[#111] p-5 hover:border-[#ff6b00]/40 transition-colors group">
              <MapPin className="w-5 h-5 text-[#4f8ef7] flex-shrink-0 mt-0.5" />
              <div>
                ...
                <p className="font-mono-ui text-[10px] text-[#4f8ef7] mt-1 group-hover:underline">View on Google Maps →</p>
              </div>
            </motion.a>
          </div>
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
            ...
            {sent ? (
              <div className="border border-green-500/30 bg-green-500/5 px-4 py-6 text-center">
                ...
                <button onClick={() => setSent(false)} className="mt-4 font-mono-ui text-xs text-[#4f8ef7] uppercase tracking-widest hover:underline">
                  Send another
                </button>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-[#0a0a0a] border border-[#333] text-white font-mono-ui text-sm px-3 py-2.5 focus:outline-none focus:border-[#4f8ef7]/60"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full bg-[#0a0a0a] border border-[#333] text-white font-mono-ui text-sm px-3 py-2.5 focus:outline-none focus:border-[#4f8ef7]/60 resize-none"
                  />
                </div>
                <button
                  type="submit"
