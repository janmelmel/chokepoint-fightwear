            ...
            {cart.length > 0 && (
              <div className="p-4 border-t border-[#1a1a1a] space-y-3">
                ...
                <Link to="/Checkout" onClick={onClose}
                  className="btn-glow-orange w-full py-3.5 font-mono-ui text-xs tracking-widest uppercase flex items-center justify-center gap-2">
                  Proceed to Checkout
                </Link>
                <button onClick={onClose}
                  className="btn-glow-white w-full py-2.5 font-mono-ui text-xs tracking-widest uppercase">
                  Continue Shopping
                </button>
              </div>
            )}
