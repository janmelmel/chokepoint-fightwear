        ...
        <div className="p-5 space-y-4">
          ...
          {product.order_type === 'contact_to_order' ? (
            ...
            <button
              ...
              disabled={added || (availableSizes.length > 0 && !selectedSize) || (hasVariants && !selectedVariant && product.variants?.length > 0)}
              className="w-full btn-glow-orange font-mono-ui text-xs uppercase tracking-widest py-4 flex items-center justify-center gap-2 disabled:opacity-40 transition-all"
            >
