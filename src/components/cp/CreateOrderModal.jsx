...
import {
  ...
  getShippingZone, getShippingRate
      ...
      <motion.div initial={{ scale: 0.95 }} animate={{ scale: 1 }} exit={{ scale: 0.95 }}
        ...
        <div className="p-5 space-y-5">
          ...
          <div className="flex gap-3">
            <button onClick={onClose} className="btn-glow-white flex-1 py-3 font-mono-ui text-xs uppercase tracking-widest">Cancel</button>
            <button onClick={handleSubmit}
              disabled={saving || !form.customer_name || !form.product_id || !form.unit_price}
              className="btn-glow-orange flex-1 py-3 font-mono-ui text-xs uppercase tracking-widest flex items-center justify-center gap-2 disabled:opacity-40">
